 ...
 // List of arcs in the graph, a2b is the arc from node A (0) to B (1).
	...
	public void NoeudPasConnexe() {
		...
		try {
			...
			DATA.add(getShortestPathSolution(Toulouse, 22345, 28413, 0, 'd'));
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void testSansOracle() {
		...
		try {
			...
			DATA.add(getShortestPathSolution(Toulouse, 555, 123, 0, 'd'));
			DATA.add(getShortestPathSolution(Toulouse, 555, 123, 2, 'd'));
			DATA.add(getShortestPathSolution(Aveyron, 5874, 496, 0, 'd'));
			DATA.add(getShortestPathSolution(Aveyron, 5874, 496, 2, 'd'));
		} catch (Exception e) {
			e.printStackTrace();
		}
